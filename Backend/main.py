...
async def send_email_with_attachment(sender, recipient, attachment_file, rendered_template,template_name):
    ...
    try:
        ...
        response = ses.send_raw_email(
            ...
            RawMessage={
                'Data': create_raw_message(sender, recipient, rendered_template, attachment_data, attachment_filename,template_name)
            }
        )
...
def create_raw_message(sender, recipient, template_content, attachment_data, attachment_filename,template_name):
    try:
            ...
            if recipient_email and not pd.isna(recipient_email):
                try:
                    ...
                    response = await send_email_with_attachment(
                        ...
                        rendered_template,template_name
                    )
